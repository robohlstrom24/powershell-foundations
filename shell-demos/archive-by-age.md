...
User-facing directories (such as Downloads) often accumulate stale files over time.  
This demo illustrates a safe, repeatable cleanup operation using time-based filtering and basic PowerShell pipelines.
